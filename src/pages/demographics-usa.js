  ...
  <Layout>
    ...
    <blockquote>
      ...
      <Section num={++sections} summary="American religious belief and behavior have declined alongside religious identification, as Gallup has consistently shown, so Americans are not simply becoming less fond of Christian organizations. Americans are increasingly abandoning religion entirely.">
        ...
        <Note num={++notes}>Bill Maher, <em>Real Time with Bill Maher</em> Season 10 Episode 13 (2012, April 20). It used to be on YouTube, but after that video was taken down, I have not been able to find the episode in full. I have found summaries of it on <Hyperlink to="https://www.imdb.com/title/tt2353033/">iMDB,</Hyperlink> <Hyperlink to="https://www.real-time-with-bill-maher-blog.com/index/2012/4/20/real-time-guest-list-april-20-2012.html">Maher's blog</Hyperlink>, and <Hyperlink to="https://www.metacritic.com/tv/real-time-with-bill-maher/season-10/episode-13-245">Metacritic</Hyperlink>.</Note>
        Douthat's first example is surprisingly correct, because the <Hyperlink to="http://www.pewresearch.org/?p=1434/multiple-religious-practices-reincarnation-astrology-psychic">proportion of Americans reporting a religious/mystical experience has doubled since 1962</Hyperlink>, but his second example is demonstrably false.
        <br /><br />
